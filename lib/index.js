...
const MongooseConnections = require('./mongooseconnections')
const MongoooseDbAdapter = require('./mongooseadapter')
...
exported.MongooseConnections = MongooseConnections
exported.MongoooseDbAdapter = MongoooseDbAdapter
